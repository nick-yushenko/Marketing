...
document.addEventListener("DOMContentLoaded", function () {
  ...
  menuBtn.addEventListener('click', function (e) {
    ...
    main.classList.toggle('is-menu_active')
    header.classList.toggle('is-header_fixed')
    header.classList.toggle('is-header_active')
    html.classList.toggle('is-html_active')
    html.classList.toggle('element')
  })
...
if (showAllStages != null) {
  ...
  showAllStages.addEventListener('click', function (e) {
    ...
    stages.forEach(stage => {
      ...
      stage.style.display = (width <= 576) ? 'flex' : 'block'
    })
  })
